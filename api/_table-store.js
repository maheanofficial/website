import {
    deleteRows as d1DeleteRows,
    insertRows as d1InsertRows,
    listRows as d1ListRows,
    updateRows as d1UpdateRows,
    upsertRows as d1UpsertRows
} from './_d1-table-store.js';
import {
...
import { dbBackend, dbConfigError, isD1Enabled, isMysqlEnabled } from './_db-config.js';

const d1Store = {
    listRows: d1ListRows,
    insertRows: d1InsertRows,
    upsertRows: d1UpsertRows,
    updateRows: d1UpdateRows,
    deleteRows: d1DeleteRows
};
...
const activeStore = isD1Enabled
    ? d1Store
    : (isMysqlEnabled ? mysqlStore : jsonStore);
