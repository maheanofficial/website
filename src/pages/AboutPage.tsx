    ...
    return (
        <>
            ...
            <div className="legal-container">
                ...
                <section className="legal-section">
                    <h2>GolpoHub সম্পর্কে</h2>
                    <p>
                        GolpoHub হলো আমার তৈরি একটি বাংলা গল্পের প্ল্যাটফর্ম যেখানে বাংলাদেশের প্রতিভাবান
                        নতুন ও অভিজ্ঞ লেখকরা তাদের মৌলিক সৃষ্টিকর্ম প্রকাশ করতে পারেন। পাঠকরা এখানে
                        থ্রিলার, হরর, রোমান্স, গোয়েন্দা, অ্যাডভেঞ্চার সহ বিভিন্ন ধরনের বাংলা গল্প পড়তে পারেন।
                        প্রতিদিন নতুন গল্প যোগ হচ্ছে এবং পাঠকসংখ্যা দিন দিন বাড়ছে।
                    </p>
                    <p>
                        আমাদের লেখক পোর্টালের মাধ্যমে যে কেউ নিজের মৌলিক গল্প জমা দিতে পারেন।
                        আমরা প্রতিটি গল্প রিভিউ করে প্রকাশ করি এবং লেখকদের একটি বড় পাঠকশ্রেণীর কাছে
                        পৌঁছানোর সুযোগ করে দিই।
                    </p>
                </section>
