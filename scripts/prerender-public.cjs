...
const STATIC_VISIBLE_SNAPSHOTS = {
  ...
  '/': {
    heading: 'Mahean Ahmed — বাংলা গল্প ও অডিওবুকের জগতে স্বাগতম',
    paragraphs: [
      'Mahean Ahmed একজন বাংলা ভয়েস আর্টিস্ট এবং গল্পকার, যিনি উচ্চমানের বাংলা অডিওবুক, গল্প নারেশন এবং ক্রিয়েটিভ কন্টেন্ট তৈরি করেন।',
      'এই ওয়েবসাইটে আপনি পাবেন: রোমান্স, থ্রিলার, হরর এবং অ্যাডভেঞ্চার সহ বিভিন্ন ধরনের বাংলা গল্প; একাধিক পর্বে বিভক্ত ধারাবাহিক গল্পসিরিজ; বাংলা অডিওবুকের কিউরেটেড কালেকশন।',
      'প্রতিটি গল্প দক্ষ লেখকদের দ্বারা রচিত এবং পাঠকদের জন্য সতর্কতার সাথে সম্পাদিত। নতুন গল্প নিয়মিত প্রকাশিত হয়।',
      'Mahean Ahmed YouTube-এ বাংলা অডিওবুক নারেশনের জন্যও পরিচিত। ভয়েস ওভার প্রজেক্ট বা কোলাবোরেশনের জন্য যোগাযোগ করুন।'
    ],
    links: [
      { href: '/stories', label: 'সব গল্প দেখুন' },
      { href: '/audiobooks', label: 'অডিওবুক লাইব্রেরি' },
      { href: '/authors', label: 'লেখকদের পরিচিতি' },
      { href: '/contact', label: 'যোগাযোগ করুন' }
    ]
  },
  '/about': {
    heading: 'About Mahean Ahmed — পরিচিতি',
    paragraphs: [
      'Mahean Ahmed একজন বাংলাদেশী ভয়েস আর্টিস্ট, গল্পকার এবং কন্টেন্ট ক্রিয়েটর যিনি বাংলা সাহিত্য ও অডিও স্টোরিটেলিং-এর প্রতি গভীরভাবে নিবেদিত।',
      'তিনি YouTube-এ বাংলা অডিওবুক নারেশন তৈরি করেন এবং mahean.com প্ল্যাটফর্মের মাধ্যমে বাংলা গল্পকারদের একটি সক্রিয় সম্প্রদায় গড়ে তুলেছেন।',
      'কাজের ক্ষেত্র: বাংলা ভয়েস ওভার, অডিওবুক নারেশন, গল্প সম্পাদনা, এবং ডিজিটাল পাবলিশিং।',
      'যোগাযোগ: ভয়েস ওভার প্রজেক্ট, কোলাবোরেশন বা অন্যান্য বিষয়ে maheanofficial@gmail.com-এ যোগাযোগ করুন।'
    ],
    links: [
      { href: '/contact', label: 'Contact Mahean Ahmed' },
      { href: 'mailto:maheanofficial@gmail.com', label: 'maheanofficial@gmail.com' }
    ]
  },
  '/privacy': {
    heading: 'গোপনীয়তা নীতি — Privacy Policy',
    paragraphs: [
      'mahean.com আপনার গোপনীয়তাকে সর্বোচ্চ গুরুত্ব দেয়। এই নীতিটি ব্যাখ্যা করে আমরা কীভাবে ব্যবহারকারীর তথ্য সংগ্রহ, ব্যবহার এবং সুরক্ষিত রাখি।',
      'তথ্য সংগ্রহ: আমরা ব্যক্তিগত তথ্য (নাম, ইমেইল) শুধুমাত্র যোগাযোগ ফর্মের মাধ্যমে সংগ্রহ করি। এছাড়া ব্রাউজিং ডেটা, পেজ ভিজিট, এবং সেশন তথ্য বিশ্লেষণের জন্য সংগ্রহ করা হতে পারে।',
      'কুকিজ ব্যবহার: এই সাইটে Google AdSense এবং Analytics-এর জন্য কুকিজ ব্যবহার করা হয়। কুকিজের মাধ্যমে আপনার পছন্দ এবং ব্রাউজিং অভিজ্ঞতা উন্নত করা হয়। আপনি ব্রাউজার সেটিংস থেকে কুকিজ নিয়ন্ত্রণ করতে পারেন।',
      'Google AdSense: এই ওয়েবসাইটে Google AdSense বিজ্ঞাপন পরিষেবা ব্যবহার করা হয়। Google এবং তার পার্টনাররা আপনার ব্রাউজিং আচরণের উপর ভিত্তি করে বিজ্ঞাপন দেখাতে পারে। বিজ্ঞাপন পছন্দ পরিবর্তন করতে adsettings.google.com ভিজিট করুন।',
      'তথ্যের ব্যবহার: সংগৃহীত তথ্য শুধুমাত্র সাইটের পরিষেবা উন্নত করতে, আপনার প্রশ্নের উত্তর দিতে এবং আইনি বাধ্যবাধকতা পূরণ করতে ব্যবহৃত হয়। আমরা কখনো তৃতীয় পক্ষের কাছে আপনার ব্যক্তিগত তথ্য বিক্রি করি না।',
      'ডেটা সংরক্ষণ: আপনার তথ্য ততক্ষণ পর্যন্ত সংরক্ষণ করা হয় যতক্ষণ পরিষেবার জন্য প্রয়োজন বা আইনি বাধ্যবাধকতা অনুযায়ী প্রয়োজন।',
      'ব্যবহারকারীর অধিকার: আপনি যেকোনো সময় আপনার ব্যক্তিগত তথ্য দেখতে, সংশোধন করতে বা মুছে দেওয়ার অনুরোধ করতে পারেন। এর জন্য maheanofficial@gmail.com-এ যোগাযোগ করুন।',
      'শিশুদের গোপনীয়তা: এই সাইট ১৩ বছরের কম বয়সীদের জন্য নয়। আমরা জেনেশুনে শিশুদের তথ্য সংগ্রহ করি না।',
      'নীতি পরিবর্তন: এই গোপনীয়তা নীতি যেকোনো সময় আপডেট হতে পারে। পরিবর্তন এই পেজে প্রকাশ করা হবে।'
    ],
    links: [
      { href: 'https://adsettings.google.com/', label: 'Google AdSense Settings' },
      { href: 'https://www.aboutads.info/choices/', label: 'Ad Opt-Out' },
      { href: '/ads.txt', label: 'Our ads.txt' }
    ]
  },
  '/terms': {
    heading: 'ব্যবহারের শর্তাবলী — Terms and Conditions',
    paragraphs: [
      'mahean.com ওয়েবসাইট ব্যবহার করে আপনি এই শর্তাবলীতে সম্মত হচ্ছেন। যদি আপনি সম্মত না হন, দয়া করে এই সাইট ব্যবহার থেকে বিরত থাকুন।',
      'কপিরাইট এবং মেধাস্বত্ব: এই ওয়েবসাইটের সমস্ত কন্টেন্ট, গল্প, অডিওবুক, ছবি এবং অন্যান্য উপাদান কপিরাইট দ্বারা সুরক্ষিত। লেখকদের লিখিত অনুমতি ছাড়া কোনো কন্টেন্ট পুনরুৎপাদন, বিতরণ বা বাণিজ্যিক ব্যবহার কঠোরভাবে নিষিদ্ধ।',
      'ব্যবহারকারীর দায়িত্ব: আপনি শুধুমাত্র বৈধ উদ্দেশ্যে এই ওয়েবসাইট ব্যবহার করবেন। অন্যদের অধিকার লঙ্ঘন, ক্ষতিকারক সফটওয়্যার প্রেরণ, বা সাইটের নিরাপত্তা বিঘ্নিত করা সম্পূর্ণ নিষিদ্ধ।',
      'কন্টেন্ট জমা দেওয়া: ব্যবহারকারীরা গল্প জমা দিতে পারেন। জমা দেওয়া কন্টেন্ট অবশ্যই মৌলিক, কপিরাইটমুক্ত এবং আমাদের কন্টেন্ট নীতি মেনে চলতে হবে। আমরা যেকোনো নীতিভঙ্গকারী কন্টেন্ট অপসারণ করার অধিকার সংরক্ষণ করি।',
      'বিজ্ঞাপন নীতি: এই সাইটে Google AdSense বিজ্ঞাপন প্রদর্শিত হয়। বিজ্ঞাপনের বিষয়বস্তুর জন্য আমরা দায়ী নই। বিজ্ঞাপন ক্লিক করে তৃতীয় পক্ষের সাইটে গেলে তাদের নিজস্ব শর্তাবলী প্রযোজ্য হবে।',
      'দায়বদ্ধতার সীমাবদ্ধতা: এই ওয়েবসাইট ব্যবহার থেকে সৃষ্ট কোনো প্রত্যক্ষ বা পরোক্ষ ক্ষতির জন্য আমরা দায়ী নই। কন্টেন্ট শুধুমাত্র তথ্য ও বিনোদনের উদ্দেশ্যে প্রদান করা হয়।',
      'তৃতীয় পক্ষের লিংক: এই সাইটে বাইরের ওয়েবসাইটের লিংক থাকতে পারে। সেসব সাইটের কন্টেন্টের জন্য আমরা দায়ী নই।',
      'শর্তাবলী পরিবর্তন: আমরা যেকোনো সময় এই শর্তাবলী পরিবর্তন করতে পারি। পরিবর্তিত শর্তাবলী এই পেজে প্রকাশিত হবে এবং প্রকাশের পর থেকে কার্যকর হবে।',
      'যোগাযোগ: শর্তাবলী সম্পর্কিত কোনো প্রশ্নের জন্য maheanofficial@gmail.com-এ যোগাযোগ করুন।'
    ]
  },
  '/disclaimer': {
    heading: 'দাবিত্যাগ — Disclaimer',
    paragraphs: [
      'mahean.com-এ প্রকাশিত সকল কন্টেন্ট তথ্যমূলক ও বিনোদনমূলক উদ্দেশ্যে প্রদান করা হয়। আমরা তথ্যের সঠিকতার চেষ্টা করি, তবে সম্পূর্ণ নির্ভুলতার নিশ্চয়তা দিতে পারি না।',
      'Google AdSense বিজ্ঞাপন ঘোষণা: এই ওয়েবসাইটে Google AdSense-এর মাধ্যমে তৃতীয় পক্ষের বিজ্ঞাপন প্রদর্শিত হয়। Google এবং তার বিজ্ঞাপন পার্টনাররা আপনার ব্রাউজিং আচরণ ও ডিভাইস তথ্যের উপর ভিত্তি করে ব্যক্তিকৃত বিজ্ঞাপন দেখাতে কুকিজ ব্যবহার করতে পারে।',
      'ব্যবহারকারী-জমাকৃত কন্টেন্ট: কিছু গল্প নিবন্ধিত লেখকদের মাধ্যমে জমা হয়। আমরা সব কন্টেন্ট মডারেট করি, তবে সকল নীতিভঙ্গ তাৎক্ষণিকভাবে শনাক্ত করার নিশ্চয়তা দেওয়া সম্ভব নয়। নিষিদ্ধ কন্টেন্টের উদাহরণ: যৌনভাবে স্পষ্ট কন্টেন্ট, বিদ্বেষমূলক বক্তব্য, কপিরাইট লঙ্ঘন, এবং প্রতারণামূলক তথ্য।',
      'কপিরাইট নীতি (DMCA): যদি আপনি বিশ্বাস করেন যে আপনার কপিরাইটকৃত কন্টেন্ট এই সাইটে অনুমতি ছাড়া প্রকাশিত হয়েছে, তাহলে maheanofficial@gmail.com-এ যোগাযোগ করুন। আমরা বৈধ অভিযোগ দ্রুত পর্যালোচনা করব এবং প্রয়োজনে কন্টেন্ট অপসারণ করব।',
      'বাহ্যিক লিংক: এই সাইটে তৃতীয় পক্ষের ওয়েবসাইটের লিংক থাকতে পারে। সেসব সাইটের কন্টেন্ট, গোপনীয়তা নীতি বা অনুশীলনের জন্য আমরা দায়ী নই।',
      'দায়বদ্ধতার সীমাবদ্ধতা: এই সাইটের তথ্য ব্যবহার থেকে সৃষ্ট যেকোনো সরাসরি বা পরোক্ষ ক্ষতির জন্য mahean.com বা Mahean Ahmed দায়ী নন।',
      'পেশাদার পরামর্শ প্রতিস্থাপন নয়: সাইটের কোনো কন্টেন্ট আইনি, চিকিৎসা, আর্থিক বা পেশাদার পরামর্শের বিকল্প নয়।',
      'নীতি আপডেট: এই দাবিত্যাগ যেকোনো সময় আপডেট হতে পারে। সর্বশেষ সংস্করণ সবসময় এই পেজে পাওয়া যাবে।'
    ],
    links: [
      { href: 'https://www.google.com/settings/ads', label: 'Google Ads Settings' },
      { href: 'mailto:maheanofficial@gmail.com', label: 'DMCA / Copyright Contact' }
    ]
  },
  '/contact': {
