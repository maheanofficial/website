...
ALTER TABLE stories ADD COLUMN IF NOT EXISTS season INTEGER DEFAULT 1;
ALTER TABLE stories ADD COLUMN IF NOT EXISTS completion_status TEXT DEFAULT 'ongoing' CHECK (completion_status IN ('ongoing', 'completed'));
ALTER TABLE stories ADD COLUMN IF NOT EXISTS rating INTEGER DEFAULT 0;
